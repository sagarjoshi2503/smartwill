...
from _app.shared.constants import HTTP_BAD_REQUEST, HTTP_UNAUTHORIZED, BAD_GOOGLE_CRED, MALFORMED_CREDENTIALS
...
def decode_transport_password(encoded_password: str) -> str:
    ...
    try:
        ...
        raise AppError(HTTP_BAD_REQUEST, MALFORMED_CREDENTIALS)

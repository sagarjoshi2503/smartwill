...
from _app.shared.constants import (
    FLD_EMAIL, FLD_FULL_NAME, FLD_NAME, FLD_PASSWORD, FLD_TOKEN, FULL_NAME_REQUIRED, HTTP_BAD_REQUEST,
    INVALID_EMAIL, MIN_PASSWORD_LENGTH, PASSWORD_TOO_SHORT, ROLE_ADMIN,
)
from _app.shared.validators import is_valid_email, normalize_email


def signup_admin(db: Database, body: dict, settings: Settings) -> dict:
    ...
    token = create_access_token(email, ROLE_ADMIN, settings)
    return {FLD_NAME: full_name, FLD_EMAIL: email, FLD_TOKEN: token}

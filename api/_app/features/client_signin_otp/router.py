...
from _app.features.client_signin_otp import service
from _app.features.client_signin_otp.schemas import EmailOtpVerifyResponse, ErrorResponse, OtpRequestResponse, OtpVerifyResponse
from _app.shared.constants import HTTP_BAD_REQUEST

router = APIRouter(prefix="/api/auth/otp", tags=["client-signin-otp"])

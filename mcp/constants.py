...
PATH_OTP_VERIFY_EMAIL = "/api/auth/otp/verify-email"
...
PATH_VOUCHER_ORDER = "/api/gift-voucher/order"
PATH_VOUCHER_PURCHASE = "/api/gift-voucher/purchase"
PATH_VOUCHER_VERIFY = "/api/gift-voucher/verify"
PATH_VOUCHER_REDEEM = "/api/gift-voucher/redeem"
PATH_VOUCHER_ADMIN_GENERATE = "/api/gift-voucher/admin/generate"
PATH_VOUCHER_ADMIN_LIST = "/api/gift-voucher/admin/list"
PATH_CLIENT_PROFILE = "/api/client/profile"
PATH_CLIENT_PROFILE_MOBILE_REQUEST_OTP = "/api/client/profile/mobile/request-otp"
PATH_CLIENT_PROFILE_MOBILE_VERIFY_OTP = "/api/client/profile/mobile/verify-otp"
...
# Gift voucher purchase verification uses its own camelCase field names —
# distinct from FLD_RAZORPAY_ORDER_ID/_PAYMENT_ID/_SIGNATURE above, which are
# the snake_case names /api/payments/verify expects. Don't conflate the two.

...
export default function ForwardLegacy() {
  ...
  // Beneficiary ops
  const addBene = () => setWill(p=>({...p, beneficiaries:[...p.beneficiaries,{id:Date.now(),beneficiaryType:"individual",name:"",relation:"Son",relationOther:"",dateOfBirth:"",maritalStatus:"",occupation:"",occupationOther:"",address:"",pan:"",aadhaarNumber:"",orgName:"",orgRepName:"",orgRegNumber:"",orgAddress:""}]}));

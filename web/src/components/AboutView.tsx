...
const TEAM = [
  { initials:"AP", name:"Anup Prabhu Verlekar", role:"Founder & Legal Architect", blurb:"Founded the practice, developed the idea, and built its legal foundation." },
  { initials:"AK", name:"Anushka Kamat", role:"Product & Brand", blurb:"Helped shape the product's early direction and identity." },
    ...
    <div className="fade-in">
      <section className="bg-slate-50 py-14 px-5 border-b border-slate-200">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-black text-slate-900 serif leading-tight max-w-2xl">A legacy practice built the way we'd want our own family's estate handled.</h1>
        </div>
      </section>

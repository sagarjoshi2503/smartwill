      ...
      <div className="min-h-full flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-lg apv-card shadow-2xl">
          <div className="bg-gradient-to-r from-[#4F9D33]/15 to-[#4F9D33]/10 border-b border-slate-200 p-5 rounded-t-3xl flex gap-4">
            <AlertTriangle size={22} className="text-[#4F9D33] shrink-0 mt-0.5"/>
          ...
          <div className="p-6">
            <div className="flex items-start gap-3 bg-[#F3F7E7]/20 border border-[#f59e0b]/20 rounded-3xl p-4 mb-6">
              <Lock size={18} className="text-[#4F9D33] mt-0.5 shrink-0"/>
            ...
            <div className="space-y-3 mb-6">
              {items.map(item=>(
                <label key={item.k}
                  ...
                  <div className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center shrink-0 mt-1 transition-all peer-focus-visible:ring-2 peer-focus-visible:ring-[#4F9D33] peer-focus-visible:ring-offset-2 ${dchecks[item.k as keyof DisclaimerChecks]?"bg-[#4F9D33] border-[#4F9D33]":"border-slate-300"}`}>

          ...
          <div className="p-6">
            <div className="bg-slate-50 border border-slate-200 border-l-4 border-l-[#4F9D33] rounded-xl p-4 mb-4">
              ...
              <ul className="space-y-1.5">
                ...
                <li className="text-slate-600 text-xs leading-relaxed pl-4 relative before:content-['•'] before:text-brand before:absolute before:left-0 before:font-bold">ID fields remain locked until you reach the final review stage.</li>

...
export const PLANS: Plan[] = [
  ...
  { id: "premium", name: "Succession Deed", price: 29999, gradient: "from-[#2F8132] to-[#a37843]", icon: <Star size={18} />, badge: null, features: ["All Registration features","Doorstep lawyer visit","Doorstep notarization","90-min consultation","3-year support"], willType: "successiondeed" },

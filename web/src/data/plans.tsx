...
export const PLANS: Plan[] = [
  { id: "notarized", name: "Non-Goan (All-India) Will", price: 4999, gradient: "from-slate-700 to-slate-800", icon: <FileText size={18} />, badge: null, features: ["Lawyer-drafted Will","Free notarization","1-year free updates","Digital certified copy","Email support"], willType: "allindia" },

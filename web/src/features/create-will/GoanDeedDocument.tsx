      ...
      <style>{`
        ...
        @media print {
          ...
          /* pdf-sig-line-footer is position:absolute, which never reserves
             ...
             it. This footer is two lines (Testator + Testatrix) at 12pt/
             line-height 2, ~17mm tall; 24mm leaves clearance. Trade-off: on
             a page whose content is already very close to a full page, this
          ...
          .pdf-page-content-footer-gap{padding-bottom:24mm}

            ...
            <div className="space-y-3 mb-6">
              {clientWillTypeOptions.map(opt=>(
                <label key={opt.id}
                  ...
                  <div className={`w-4 h-4 mt-0.5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all peer-focus-visible:ring-2 peer-focus-visible:ring-[#4F9D33] peer-focus-visible:ring-offset-2 ${selected===opt.id?"border-brand bg-brand":"border-slate-300"}`}>

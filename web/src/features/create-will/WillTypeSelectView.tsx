      ...
      <div className="min-h-full flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-lg apv-card shadow-2xl">
          <div className="bg-gradient-to-r from-[#2F8132]/15 to-[#2F8132]/10 border-b border-slate-200 p-5 rounded-t-3xl flex gap-4">
            <FileText size={22} className="text-[#2F8132] shrink-0 mt-0.5"/>
            ...
            <div className="space-y-3 mb-6">
              {WILL_TYPE_OPTIONS.map(opt=>(
                <label key={opt.id}
                  ...
                  <div className={`w-4 h-4 mt-0.5 rounded-full border-2 flex items-center justify-center shrink-0 transition-all peer-focus-visible:ring-2 peer-focus-visible:ring-[#2F8132] peer-focus-visible:ring-offset-2 ${selected===opt.id?"border-[#2F8132] bg-[#2F8132]":"border-slate-300"}`}>
